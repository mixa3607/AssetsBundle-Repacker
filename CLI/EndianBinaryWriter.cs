...
namespace CLI
{
    ...
    {
        public CLI.EndianType endian;

        public EndianBinaryWriter(Stream stream, CLI.EndianType endian = CLI.EndianType.BigEndian) : base(stream)
        {
            this.endian = endian;
        }
        ...
        public override void Write(int num)
        {
            ...
            if (endian == CLI.EndianType.BigEndian)
            {
